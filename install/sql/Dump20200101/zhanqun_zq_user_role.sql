...
CREATE TABLE `zq_user_role` (
  ...
  `ur_permissions` varchar(200) CHARACTER SET utf8 DEFAULT NULL,
  `ur_name` varchar(45) CHARACTER SET utf8 DEFAULT NULL,
  `ur_add_time` int(11) DEFAULT NULL,
  `ur_update_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`ur_id`)
...
-- Dump completed on 2020-01-01 18:52:21
