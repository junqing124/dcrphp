...
CREATE TABLE `zq_user` (
  ...
  `u_is_super` tinyint(1) DEFAULT '0' COMMENT '是不是超级帐号',
  PRIMARY KEY (`u_id`),
...
INSERT INTO `zq_user` VALUES (1,'admin',NULL,'dcJ49.bznhA7c',1,1583134320,1583134320,'unknown',26,1584521794,1,1,'15718126135','','管理员',0,NULL,1),(2,'张三',NULL,'dcJ49.bznhA7c',1,1583034580,1583034651,NULL,0,NULL,1,1,'15718126135','','测试用户1',1,1,0),(3,'李四',NULL,'dcJ49.bznhA7c',1,1583034614,1584523136,'unknown',5,1584523130,1,2,'15718126135','8420124','',1,1,1);
