...
CREATE TABLE `zq_config_table_edit_item` (
  ...
  `ctei_add_time` int(11) NOT NULL DEFAULT '0',
  `ctei_update_time` int(11) NOT NULL DEFAULT '0',
  `ctei_approval_status` tinyint(4) NOT NULL DEFAULT '1',
  `ctei_add_user_id` smallint(6) NOT NULL DEFAULT '0',
...
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8 COMMENT='单表配置字段';
