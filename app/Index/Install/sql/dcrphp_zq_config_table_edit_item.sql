...
INSERT INTO `zq_config_table_edit_item` VALUES (11,1588232180,1588232469,1,1,1,'','','','','','','','','','是','string','ID','ctei_id',2),(17,1588236303,1588236549,1,1,1,'是','','','','','','是','','','是','string','父表ID','ctei_ctel_id',2),(18,1588236592,1588236654,1,1,1,'','','是','是','是','小写英文字母开头，只能小写英文及数字','是','like','是','是','string','字段名','ctei_db_field_name',2),(19,1588236657,1588236683,1,1,1,'','','是','是','是','','是','like','是','是','string','标题','ctei_title',2),(20,1588237014,1588237037,1,1,1,'','','是','是','是','','是','','','是','string','数据类型','ctei_data_type',2),(21,1588237039,1588237068,1,1,1,'','是','','是','','','是','','','是','checkbox','列表中显示','ctei_is_show_list',2),(22,1588237069,1588237094,1,1,1,'','是','','是','','','是','','','是','checkbox','列表中能搜索','ctei_is_search',2),(23,1588237096,1588237115,1,1,1,'','是','','是','','','是','','','是','checkbox','能添加','ctei_is_insert',2),(24,1588237120,1588237143,1,1,1,'','是','','是','','','是','','','是','checkbox','添加必填','ctei_is_insert_required',2),(25,1588237144,1588237161,1,1,1,'','是','','是','','','是','','','是','checkbox','能更新','ctei_is_update',2),(26,1588237178,1588237196,1,1,1,'','是','','是','','','是','','','是','checkbox','更新必填','ctei_is_update_required',2),(27,1588237198,1588237245,1,1,1,'','是','','是','','编辑页面类型为hidden','是','','','','checkbox','input hidden','ctei_is_input_hidden',2),(28,1588237247,1588237277,1,1,1,'','','','是','','','是','','','是','string','搜索类型','ctei_search_type',2),(29,1588237280,1588237294,1,1,1,'','','','是','','','是','','','','string','提示','ctei_tip',2),(30,1588237296,1588237316,1,1,1,'','','','是','','','是','','','是','string','默认值','ctei_default',2),(33,1588240674,1588240698,1,1,1,'','','','','','','','','','是','string','ID','ctel_id',1),(34,1588240699,1588240734,1,1,1,'','','是','是','是','','是','','是','是','string','关键字','ctel_key',1),(35,1588240735,1588240755,1,1,1,'','','是','是','是','','是','','是','是','string','页面标题','ctel_page_title',1),(36,1588240758,1588240781,1,1,1,'','','是','是','是','','是','','','是','string','模块名','ctel_page_model',1),(37,1588240832,1588240845,1,1,1,'','','是','是','是','','是','','是','是','string','表名','ctel_table_name',1),(38,1588240846,1588240861,1,1,1,'','','是','是','是','','是','','','','string','主键名','ctel_index_id',1),(39,1588241160,1588241185,1,1,1,'','','是','是','是','不要以_结尾','是','','','是','string','表前缀','ctel_table_pre',1),(40,1588241187,1588241210,1,1,1,'','是','','是','','','是','','','是','checkbox','允许删除','ctel_is_del',1),(41,1588241211,1588241230,1,1,1,'','是','','是','','','是','','','是','checkbox','允许添加','ctel_is_add',1),(42,1588241231,1588241259,1,1,1,'','是','','是','','','是','','','是','checkbox','允许编辑','ctel_is_edit',1),(43,1588241274,1588241292,1,1,1,'','','','是','','','是','','','','string','排序','ctel_list_order',1),(44,1588241294,1588241307,1,1,1,'','','','是','','','是','','','是','string','where','ctel_list_where',1),(45,1588241312,1588241348,1,1,1,'','','','是','','添加或编辑弹出的窗口的宽以px或%结尾','是','','','是','string','编辑窗口宽','ctel_edit_window_width',1),(46,1588241356,1588241377,1,1,1,'','','','是','','添加或编辑弹出的窗口的高以px或%结尾	','是','','','是','string','编辑窗口高','ctel_edit_window_height',1),(47,1588241386,1588241541,1,1,1,'','','','是','','','是','','','','text','操作列自定义额外html','ctel_addition_option_html',1),(48,1588241542,1588241607,1,1,1,'','','','是','','配置字段允许哪些使用可以外部传入的变量，用,分隔字段。比如想通过get post配置list_order额外配置，请访问 ip/admin/tools/table-edit-list-view/zq_user?list_order=u_id,那么实际使用的list_order=list_order配置和get(','是','','','','string','允许使用外部变量','ctel_allow_config_from_request',1),(50,0,1588325649,1,1,1,'','','','是','','添加页面form额外的html','是','','','','text','添加页面form额外的html','ctel_add_page_addition_html',1),(51,0,1588325635,1,1,1,'','','','是','','编辑页面form额外的html','是','','','','text','编辑页面form额外的html','ctel_edit_page_addition_html',1),(52,0,0,1,1,1,'','','','是','','列表里添加按钮拼接html','是','','','','text','列表添加按钮拼接html','ctel_add_button_addition_html',1),(53,0,0,1,1,1,'','','','是','','列表里编辑按钮拼接html','是','','','','text','列表里编辑按钮拼接html','ctel_edit_button_addition_html',1),(54,0,0,1,1,1,'是','','','','','','','','','是','string','ID','u_id',3),(55,0,0,1,1,1,'','','','','','','','like','是','是','string','用户名','u_username',3),(56,0,0,1,1,1,'','','是','是','','','','like','是','是','string','电话','u_mobile',3),(57,1588325881,1588325881,1,1,1,'','','','是','','列表按钮区额外html','是','','','','text','列表按钮区额外html','ctel_button_area_addition_html',1);
