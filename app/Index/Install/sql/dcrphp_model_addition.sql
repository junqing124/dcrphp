...
CREATE TABLE `model_addition` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='模型附加表：ma开头是为了模型实别字段';
